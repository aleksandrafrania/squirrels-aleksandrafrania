...
# To do: fix above.ground etc column to also make a summary of it

print("Summary for Above.Gound.Sighter.Measurment")
summary(squirrels$Above.Ground.Sighter.Measurement)
```
...
```{r}
# Split October 2018 into weeks, only taking the 3 first ones (last sighting occurs on October 20th so plotting past that date is useless)
