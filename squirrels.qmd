...
# Since none of the data except coordinates and the date is numerical, it is difficult to make an interesting summarizing table. One can count the occurrence of unique values, but this can be just as well visualised in a bar plot, for instance.
